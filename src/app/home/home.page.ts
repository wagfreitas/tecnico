      ...
      this.permission
        ...
        .then((res) => {
          this.common.showToast(
            "Aplicaçao deseja permissao: " + res.hasPermission
          );
      ...
      this.geolocation
        ...
        .then(
          ...
          (err) => {
            ...
            this.common.showToast(
              "Houve um problema para determinar a sua localizaçao"
            );
      ...
      if (user != null) {
          ...
          .subscribe((snapshot: any) => {
            if (snapshot != null) {
              ...
              if (this.driver.isOnline && this.platform.is("mobile")) {
                ...
                cordova.plugins.backgroundMode.on("active", () =>
                  console.log("bgm: active")
                );
                cordova.plugins.backgroundMode.on("deactivate", () =>
                  console.log("bgm: deactive")
                );
                cordova.plugins.backgroundMode.on("failure", () =>
                  console.log("bgm: failed")
                );
        ...
        this.tripService
          ...
          .subscribe((trips: any) => {
            trips.forEach((trip) => {
              if (
                trip.status == TRIP_STATUS_WAITING ||
                trip.status == TRIP_STATUS_GOING
              ) {
