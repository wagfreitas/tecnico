  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["common"], {
    ...
    function srcAppServicesCommonServiceTs(module, __webpack_exports__, __webpack_require__) {
      ...
      var CommonService = /*#__PURE__*/function () {
        function CommonService(toast, alertCtrl, loadCtrl, platform, translate, geolocation) {
          ...
          value: function enableBgMode() {
            if (this.platform.is('android') || this.platform.is("ios")) {
              ...
              cordova.plugins.backgroundMode.on('disable', function () {
                return console.log('bgm: disable');
              });
            } else {// this.showToast("Background mode only works on device");
            }
          }
        }, {
          key: "disableBgMode",
          value: function disableBgMode() {
    ...
    function srcAppServicesDealServiceTs(module, __webpack_exports__, __webpack_require__) {
      ...
      var _trip_service__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
      /*! ./trip.service */
      ...
      var DealService = /*#__PURE__*/function () {
        ...
        _createClass(DealService, [{
          key: "getDeal",
          value: function getDeal(driverId) {
          ...
          key: "acceptDeal",
          value: function acceptDeal(driverId, deal) {
            var _this2 = this;

            deal.driverId = driverId; // create trip from deal

            return this.tripService.createFromDeal(deal).then(function (trip) {
              _this2.tripService.setCurrentTrip(trip.key); // set tripId to deal


              return _this2.db.object('deals/' + driverId).update({
                status: src_environments_environment_prod__WEBPACK_IMPORTED_MODULE_4__["DEAL_STATUS_ACCEPTED"],
                tripId: trip.key
              });
            });
          }
          ...
          value: function setLocalityFromGeocoder(results) {
            ...
            for (var i = 0; i < results.length; i++) {
              ...
              for (var j = 0; j < address.address_components.length; j++) {
                component = address.address_components[j]; // if (component.types[0] == 'locality') {
