  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["pagamentos-pagamentos-module"], {
    ...
    function srcAppPagamentosPagamentosPageTs(module, __webpack_exports__, __webpack_require__) {
      ...
      var PagamentosPage = /*#__PURE__*/function () {
        function PagamentosPage(pagseg, storage, formBuilder, common) {
        ...
        _createClass(PagamentosPage, [{
          ...
          value: function ngOnInit() {
            ...
            this.pagseg.carregaEstados().subscribe(function (res) {
              res["geonames"].forEach(function (element) {
                _this.estados.push(element.name);
              });
            });
            ...
            this.pagseg.obterIdSession(this.credenciais).subscribe(function (res) {
              ...
              _this.pagseg.carregaPagSeguroDirectPayment(_this.credenciais).then(function () {
                PagSeguroDirectPayment.setSessionId(_this.sessionId);
          ...
          key: "buscaBandeira",
          value: function buscaBandeira(value) {
            var _this3 = this;
            ...
            PagSeguroDirectPayment.getBrand({
              ...
              success: function success(response) {
                ...
                _this3.dados.bandCard = response.brand.name;
                ...
                } else if (_this3.credenciais.bandCard === 'elo') {
                  _this3.thumbnail = '../../assets/icon/elo.png';
                } else {
                ...
                while (1) {
                  switch (_context5.prev = _context5.next) {
                    case 0:
                      ...
                      val = this.ionicForm.value.valor;
                      console.log('dados', dados);
                      this.dados.amount = val.replace(',', '.'); //  this.dados.bandCard = dados.numCar

                      _context5.next = 6;
                      return PagSeguroDirectPayment.getInstallments({
                        amount: val.replace(',', '.'),
                        ...
                        success: function success(response) {
                          ...
                          _this4.parcelas["installmentAmount"] = parseFloat(_this4.parcelas["installmentAmount"]).toFixed(2); // console.log('parcelas: ' + JSON.stringify(response.installments[dados.bandCard]));
                        },
                        error: function error(response) {
          ...
          value: function pagar() {
            ...
            console.log("dados no pagar", this.dados); //console.log("hash", this.dados.hashComprador)
            ...
            PagSeguroDirectPayment.createCardToken({
              ...
              error: function error(response) {
                console.log('erro recebido', response);
              }
            });
          ...
          value: function pagarCheckoutTransp(dados) {
            ...
            var valparcelas = this.dados.parcelas[0]['installmentAmount'];
            var pagDados = {
              email: 'vinassis@gmail.com',
              data: {
                payment: {
            ...
            this.pagseg.enviarPgto(pagDados).subscribe(function (res) {
              console.log(res);

              if (res.transaction["code"]) {
                _this6.common.showToast("Pagamento Efetuado com Sucesso");

                _this6.ionicForm.reset();
              } else {
                _this6.common.showToast("Ocorreu um erro, verifique os dados");
              }
    ...
    function srcAppServicesPagSeguroServiceTs(module, __webpack_exports__, __webpack_require__) {
      ...
      var PagSeguroService = /*#__PURE__*/function (_generic_service__WEB) {
        ...
        function PagSeguroService(_http, http) {
          var _this7;

          _classCallCheck2(this, PagSeguroService);

          _this7 = _super.call(this, _http, '/api/pagseguro');
          _this7.http = http;
          _this7.URL = "http://www.geonames.org/childrenJSON?geonameId=3469034";
          return _this7;
        }
