...
const routes = [
    ...
    {
        path: 'forget',
        loadChildren: () => Promise.all(/*! import() | forget-forget-module */[__webpack_require__.e("common"), __webpack_require__.e("forget-forget-module")]).then(__webpack_require__.bind(null, /*! ./forget/forget.module */ "./src/app/forget/forget.module.ts")).then(m => m.ForgetPageModule)
    },
    {
        path: 'history',
    ...
    {
        path: 'pickup',
        loadChildren: () => Promise.all(/*! import() | pickup-pickup-module */[__webpack_require__.e("common"), __webpack_require__.e("pickup-pickup-module")]).then(__webpack_require__.bind(null, /*! ./pickup/pickup.module */ "./src/app/pickup/pickup.module.ts")).then(m => m.PickupPageModule)
    },
    {
        path: 'profile',
    ...
    {
        path: 'pagamentos',
        loadChildren: () => Promise.all(/*! import() | pagamentos-pagamentos-module */[__webpack_require__.e("common"), __webpack_require__.e("pagamentos-pagamentos-module")]).then(__webpack_require__.bind(null, /*! ./pagamentos/pagamentos.module */ "./src/app/pagamentos/pagamentos.module.ts")).then(m => m.PagamentosPageModule)
    },
    {
        path: 'produtos',
...
/* harmony import */ var _services_trip_service__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./services/trip.service */ "./src/app/services/trip.service.ts");
/* harmony import */ var _services_auth_service__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./services/auth.service */ "./src/app/services/auth.service.ts");
/* harmony import */ var _services_driver_service__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./services/driver.service */ "./src/app/services/driver.service.ts");
...
/* harmony import */ var src_environments_environment_prod__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(/*! src/environments/environment.prod */ "./src/environments/environment.prod.ts");
...
/* harmony import */ var _angular_fire_database__WEBPACK_IMPORTED_MODULE_19__ = __webpack_require__(/*! @angular/fire/database */ "./node_modules/@angular/fire/__ivy_ngcc__/fesm2015/angular-fire-database.js");
...
AppModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
        ...
        imports: [
            ...
            _angular_fire__WEBPACK_IMPORTED_MODULE_17__["AngularFireModule"].initializeApp(src_environments_environment_prod__WEBPACK_IMPORTED_MODULE_16__["environment"].firebase),
        ...
        providers: [
            ...
            _ionic_native_firebase_x_ngx__WEBPACK_IMPORTED_MODULE_8__["FirebaseX"],
    ...
    register(userInfo) {
        ...
        return rxjs__WEBPACK_IMPORTED_MODULE_4__["Observable"].create(observer => {
            ...
            this.afAuth.createUserWithEmailAndPassword(email, userInfo.password).then((authData) => {
                ...
                this.getUserData().then(user => user.updateProfile({ displayName: userInfo.name, photoURL: src_environments_environment_prod__WEBPACK_IMPORTED_MODULE_5__["DEFAULT_AVATAR"] }));
...
let DriverService = class DriverService {
    ...
    updatePosition(vehicleId, vehicleType, locality, lat, lng, rating, name) {
        let path = 'localities/' + locality + '/' + vehicleType + '/' + vehicleId;
        this.db.object(path).valueChanges().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["take"])(1)).subscribe((snapshot) => {
...
let TripService = class TripService {
    ...
    setCurrentTrip(tripId) {
        return this.db.object('trips/' + tripId).snapshotChanges().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["take"])(1)).subscribe((snapshot) => {
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "TRIP_STATUS_WAITING", function() { return TRIP_STATUS_WAITING; });
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "TRANSACTION_TYPE_WITHDRAW", function() { return TRANSACTION_TYPE_WITHDRAW; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "PLAY_AUDIO_ON_REQUEST", function() { return PLAY_AUDIO_ON_REQUEST; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "AUDIO_PATH", function() { return AUDIO_PATH; });
...
module.exports = __webpack_require__(/*! /Users/wagner/Projetos /JetPort/JetAtualPublicado/tecnico/src/main.ts */"./src/main.ts");
